...
public class CreateLead {
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Yogavady");
		
		// 9. Enter LastName Field Using id Locator
		driver.findElement(By.id("createLeadForm_lastName")).sendKeys("Ulaganathan");
		
		// 10. Enter FirstName(Local) Field Using id Locator
		driver.findElement(By.id("createLeadForm_firstNameLocal")).sendKeys("Yoga");
		...
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("yogavady@gmail.com");
